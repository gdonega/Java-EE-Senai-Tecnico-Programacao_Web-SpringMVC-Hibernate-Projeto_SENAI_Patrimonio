...
import informatica.sp.senai.br.senaipatrimonio.logic.retrofit.endpoint.AmbienteEP;
...
public class RetrofitConfig {
    ...
    public AmbienteEP getAmbienteEndPoint() {
        return this.retrofit.create(AmbienteEP.class);
    }
